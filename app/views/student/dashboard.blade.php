...
<ul class="sidebar-menu">
    ...
    <li>
        <a href="{{ URL::route('student_add_course') }}">
            <i class="fa fa-th"></i> <span>ADD NEW COURSE</span> 
        </a>
    </li>
    <li>
        <a href="{{ URL::route('student_remove_course') }}">
            <i class="fa fa-th"></i> <span>REMOVE COURSES</span> 
        </a>
    </li>
    <li>
        <a href="{{ URL::route('my_courses') }}">
            <i class="fa fa-th"></i> <span>MY COURSES</span> 
        </a>
    </li>
